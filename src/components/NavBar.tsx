...
export type AIModel = 'gemini-3-pro' | 'gemini-2.5-flash' | 'gpt-5.4';
...
const MODEL_OPTIONS: { value: AIModel; label: string; provider: string; badge: string; color: string }[] = [
  ...
  { value: 'gemini-2.5-flash', label: 'Gemini 2.5 Flash', provider: 'Google', badge: 'F', color: 'from-sky-500 to-cyan-500' },
