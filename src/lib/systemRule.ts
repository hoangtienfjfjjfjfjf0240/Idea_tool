...
export const DEFAULT_FAST_SYSTEM_RULE = [
  ...
  'Never use generic Speaker 1/Speaker 2 labels. If a visible person speaks, use the visible role/name, e.g. "Cụ ông", "Người đàn ông", "Người phụ nữ", "Bác sĩ", "Người bệnh".',
  'Every idea must include character_visual when a person appears: age, gender presentation if relevant, skin tone/ethnicity/country cue, hair, outfit, body language, and prop; use "No talent - screen recording only" when no person appears.',
  'Every idea must include camera_plan with shot sizes/angles for hook/body/CTA: wide/toan canh, medium/trung canh, close-up/can, ECU, POV, OTS, Insert, Split, top-down, or tracking.',
